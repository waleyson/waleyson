...
<div class="wrapper">
    <div class="grids top">
        ...
        <div class="grid-10 grid">
            ...
            <h2>List of Electoral Area in eBallot Database</h2>
            <p><label for="name">
            ...
            <table>
                <thead>
                    <tr>
                <a class="button" href="electArea.jsp">Add Electoral Area</a>
                </tr>
                <tr>
                    <th scope="col">&nbsp;</th>
                    <th scope="col">Electoral Area ID</th>
                    <th scope="col">Electoral Area Name</th>
                ...
                <tbody>
                    <c:forEach var="row" items="${result.rowsByIndex}">
                        <tr>
                    <form action="../MVC/respElect.jsp" method="POST">
