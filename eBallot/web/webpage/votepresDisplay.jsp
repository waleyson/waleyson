...
<div class="wrapper">
    <div class="grids top">
        ...
        <div class="grid-10 grid">
            ...
            <h2>List of Presidential vote count in eBallot Database</h2>
            <p><label for="name">
            ...
            <table>
                <thead>
                    <tr>
                <a class="button" href="votepres.jsp">Add Vote Count</a>
                </tr>
                <tr>
                    <th scope="col">&nbsp;</th>
                ...
                <tbody>
                    <c:forEach var="row" items="${result.rowsByIndex}">
                        <tr>
                    <form action="../MVC/respVotePres.jsp" method="POST">
