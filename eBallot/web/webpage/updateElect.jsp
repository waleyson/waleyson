...
<div class="wrapper">
    <div class="grids top">
        ...
        <div class="grid-10 grid">
            ...
            <form name="candidate"
                  action="${pageContext.request.contextPath}/MVC/respElect.jsp"
                  method="POST">

                <table class="form">
                    <tr>
                        <td>Electoral ID</td>
                        <td><input type="text" readonly="true" name="elect_id" value="${param.elect_id}" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="population" value="${param.population}" /></td>
                    </tr>
                    <tr>
                        <td>Country Name</td>
