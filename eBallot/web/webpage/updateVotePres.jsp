...
<div class="wrapper">
    <div class="grids top">
        ...
        <div class="grid-10 grid">
            <h4>Update/Edit Presidential Vote Count Information Here</h4>
            <label for="name">
            ...
            <form name="candidate"
                  action="${pageContext.request.contextPath}/MVC/respVotePres.jsp"
                  method="POST">

                <table class="form">
                    <tr>
                        <td>Vote ID</td>
                        <td><input type="text" readonly="true" name="id" value="${param.id}" /></td>
                    </tr>
                    <tr>
                        <td>Party Name</td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="candidate" value="${param.candidate}" /></td>
                    </tr>
                    <tr>
                        <td>Vote Count</td>

                        <td><input type="text" name="votecount" value="${param.votecount}" /></td>
                    </tr>
                    <tr>
                        <td>Name</td>

                        <td><input type="text" name="boot" value="${param.boot}" /></td>
                    </tr>
                    <tr>
