...
<div class="wrapper">
    <div class="grids top">
        ...
        <div class="grid-10 grid">
            <h4>Update/Edit Village Information Here</h4>
            <label for="name">
            ...
            <form name="candidate"
                  action="${pageContext.request.contextPath}/MVC/respVil.jsp"
                  method="POST">

                <table class="form">
                    <tr>
                        <td>Village ID</td>
                        <td><input type="text" readonly="true" name="village_id" value="${param.village_id}" /></td>
                    </tr>
                    <tr>
                        <td>Village Name</td>
