...
<% 
String constituency =request.getParameter("counts");
 String buffer="<select name='electArea'><option value='-1'>Select</option>";
 try{
 ...
 ResultSet rs = stmt.executeQuery("Select * from electarea where constituency ='"+constituency+"' ");
   while(rs.next()){
