<%-- 
    Document   : district
    Created on : Sep 28, 2014, 2:54:59 PM
    Author     : AbdHafeez
--%>
...
<div class="wrapper">
    ...
    <div class="grids top">
        ...
        <div class="grid-10 grid">
            <h4>Please Enter District/Local Government Information Here</h4>
            <label for="name">
            ...
            <form name="district"
                  action="${pageContext.request.contextPath}/MVC/districtPro.jsp"
                  method="POST">
                <table class="form">
                    <tr>
                        <th>
