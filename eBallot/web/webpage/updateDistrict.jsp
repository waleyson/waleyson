...
<div class="wrapper">
    <div class="grids top">
        ...
        <div class="grid-10 grid">
            <h4>Update/Edit District Information Here</h4>
            <label for="name">
            ...
            <form name="candidate"
                  action="${pageContext.request.contextPath}/MVC/respDist.jsp"
                  method="POST">

                <table class="form">
                    <tr>
                        <td>District ID</td>
                        <td><input type="text" readonly="true" name="district_id" value="${param.district_id}" /></td>
                    </tr>
                    <tr>
                        <td>District Name</td>
