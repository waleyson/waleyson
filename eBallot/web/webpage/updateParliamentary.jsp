...
<div class="wrapper">
    <div class="grids top">
        ...
        <div class="grid-10 grid">
            <h4>Update/Edit Parliamentary Candidate Information Here</h4>
            <label for="name">
            ...
            <form name="candidate"
                  action="${pageContext.request.contextPath}/MVC/respParl.jsp"
                  method="POST">

                <table class="form">
                    <tr>
                        <td>Mem. of Parl. ID</td>
                        <td><input type="text" readonly="true" name="parl_id" value="${param.parl_id}" /></td>
                    </tr>
                    <tr>
                        <td>Mem. of Parl. Name</td>

                        <td><input type="text" name="parl_name" value="${param.parl_name}" /></td>
                    </tr>
                    <tr>
                        <td>Party Name</td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="district" value="${param.district}" /></td>
                    </tr>
                    <tr>
                        <td>Constituency Name</td>

                        <td><input type="text" name="master_name" value="${param.master_name}" /></td>
                    </tr>
                    <tr>
                        <td>Electoral Area Name</td>

                        <td><input type="text" name="electarea" value="${param.electarea}" /></td>
                    </tr>
                    <tr>
                        <td>Polling Boot Name</td>

                        <td><input type="text" name="boot_name" value="${param.boot_name}" /></td>
                    </tr>
