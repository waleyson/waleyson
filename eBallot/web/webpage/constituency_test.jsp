...
<%
String district =request.getParameter("counts");
 String buffer="<select name='constituency' ><option value='-1'>Select</option>";
 try{
 ...
 ResultSet rs = stmt.executeQuery("Select * from master where district ='"+district+"' ");
   while(rs.next()){
