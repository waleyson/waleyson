...
<div class="wrapper">
    <div class="grids top">
        ...
        <div class="grid-10 grid">
            <h4>Update/Edit Electoral Area Information Here</h4>
            <label for="name">
            ...
            <form name="candidate"
                  action="${pageContext.request.contextPath}/MVC/respBoot.jsp"
                  method="POST">
                  					
                <table class="form">
                    <tr>
                        <td>Station</td>
                        <td><input type="text" readonly="true" name="station" value="${param.station}" /></td>
                    </tr>
                    <tr>
                        <td>Population</td>

                        <td><input type="text" name="enum_voters" value="${param.enum_voters}" /></td>
                    </tr>
                    <tr>
                        <td>District</td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="constituency" value="${param.constituency}" /></td>
                    </tr>
                    <tr>
