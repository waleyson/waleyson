...
<div class="wrapper">
    <div class="grids top">
        ...
        <div class="grid-10 grid">
            ...
            <h2>List of Mem. Of Parliaments vote count in eBallot Database</h2>
            <p><label for="name">
            ...
            <table>
                <thead>
                    <tr>
                <a class="button" href="voteparl.jsp">Add Vote Count</a>
                </tr>
                <tr>
                    <th scope="col">&nbsp;</th>
                    <th scope="col">voteparl ID</th>
                ...
                <tbody>
                    <c:forEach var="row" items="${result.rowsByIndex}">
                        <tr>
                    <form action="../MVC/respVoteParl.jsp" method="POST">
