...
<div class="wrapper">
    <div class="grids top">
        ...
        <div class="grid-10 grid">
            <h4>Update/Edit Presidential Candidate Information Here</h4>
            <label for="name">
            ...
            <form name="candidate"
                  action="${pageContext.request.contextPath}/MVC/respPres.jsp"
                  method="POST">

                <table class="form">
                    <tr>
                        <td>Presidential ID</td>
                        <td><input type="text" readonly="true" name="pre_id" value="${param.pre_id}" /></td>
                    </tr>
                    <tr>
                        <td>Presidential Name</td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" readonly="true" name="position" value="${param.position}" /></td>
                    </tr>
                    <tr>
                        <td>Party Name</td>
