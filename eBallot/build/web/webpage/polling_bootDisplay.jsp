...
<div class="wrapper">
    <div class="grids top">
        ...
        <div class="grid-10 grid">
            ...
            <h2>List of polling Boot Setup in eBallot Database</h2>
            <p><label for="name">
            ...
            <table>
                <thead>
                    <tr>
                <a class="button" href="polling_boot.jsp">Add Polling Boot</a>
                </tr>
                <tr>
                    <th scope="col">&nbsp;</th>
                ...
                <tbody>
                    <c:forEach var="row" items="${result.rowsByIndex}">
                        <tr>
                    <form action="../MVC/respBoot.jsp" method="POST">
