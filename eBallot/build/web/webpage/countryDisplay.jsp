...
<div class="wrapper">
    <div class="grids top">
        ...
        <div class="grid-10 grid">
            ...
            <h2>List of Countries in eBallot Database</h2>
            <p><label for="name">
            ...
            <table>
                <thead>
                    <tr>
                <a class="button" href="country.jsp">Add Country</a>
                </tr>
                <tr>
                    <th scope="col">&nbsp;</th>
                ...
                <tbody>
                    <c:forEach var="row" items="${result.rowsByIndex}">
                        <tr>
                    <form action="../MVC/response.jsp" method="POST">
...
<c:if test="${ not empty param.update}">
    <c:redirect url="updateCountry">
        <c:param name="updateC" value="${param.selected}"/>
    </c:redirect>
</c:if>