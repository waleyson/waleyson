...
<div class="wrapper">
    <div class="grids top">
        ...
        <div class="grid-10 grid">
            <h4>Update/Edit Constituency Information Here</h4>
            <label for="name">
            ...
            <form name="candidate"
                  action="${pageContext.request.contextPath}/MVC/respConst.jsp"
                  method="POST">

                <table class="form">
                    <tr>
                        <td>Constituency ID</td>
                        <td><input type="text" readonly="true" name="master_id" value="${param.master_id}" /></td>
                    </tr>
                    <tr>
