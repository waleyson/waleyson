...
<div class="wrapper">
    <div class="grids top">
        ...
        <div class="grid-10 grid">
            ...
            <form name="candidate"
                  action="${pageContext.request.contextPath}/MVC/userResp.jsp"
                  method="POST">

                <table class="form">
                    <tr>
                        <td>User ID</td>
                        <td><input type="text" readonly="true" name="userID" value="${param.userid}" /></td>
                    </tr>

                    <tr>
                        <td>User Previlege</td>

                        <td><select name="previlege">
                                <option></option>
                                <option>User</option>
                                <option>Admin</option>
                            </select></td>
