...
<div class="wrapper">
    <div class="grids top">
        ...
        <div class="grid-10 grid">
            <h4>Update/Edit Vote Count Information Here</h4>
            <label for="name">
            ...
            <form name="candidate"
                  action="${pageContext.request.contextPath}/MVC/respVoteParl.jsp"
                  method="POST">

                <table class="form">
                    <tr>
                        <td>Vote ID</td>
                        <td><input type="text" readonly="true" name="voteparl_id" value="${param.voteparl_id}" /></td>
                    </tr>
                    <tr>
                        <td>Party Name</td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="vote_count" value="${param.vote_count}" /></td>
                    </tr>
                    <tr>
                        <td>Name</td>
