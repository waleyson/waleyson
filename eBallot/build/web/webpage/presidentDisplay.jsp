...
<div class="wrapper">
    <div class="grids top">
        ...
        <div class="grid-10 grid">
            ...
            <h2>List of President setup in eBallot Database</h2>
            <p><label for="name">
            ...
            <table>
                <thead>
                    <tr>
                <a class="button" href="president.jsp">Add Presidential Candidate</a>
                </tr>
                <tr>
                    <th scope="col">&nbsp;</th>
                    <th scope="col">Presidential ID</th>
                    <th scope="col">Presidential Name</th>
                ...
                <tbody>
                    <c:forEach var="row" items="${result.rowsByIndex}">
                        <tr>
                    <form action="../MVC/respPres.jsp" method="POST">
