...
<div class="wrapper">
    <div class="grids top">
        ...
        <div class="grid-10 grid">
            <h4>Update/Edit Region Information Here</h4>
            <label for="name">
            ...
            <form name="candidate"
                  action="${pageContext.request.contextPath}/MVC/respReg.jsp"
                  method="POST">

                <table class="form">
                    <tr>
                        <td>Country ID</td>
                        <td><input type="text" readonly="true" name="region_id" value="${param.region_id}" /></td>
                    </tr>
                    <tr>
                        <td>Region Name</td>

                        <td><input type="text" name="region_name" value="${param.region_name}" /></td>
                    </tr>
                    <tr>
                        <td>Description</td>
