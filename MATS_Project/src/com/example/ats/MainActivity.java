...
public class MainActivity extends FragmentActivity implements
    ...
    public String getLocation() {
        ...
        if (servicesConnected()) {
            ...
            // Display the current location in the UI
            mLatLng.setText(LocationUtils.getLatLng(getBaseContext(), currentLocation));
            gps = LocationUtils.getLatLng(getBaseContext(), currentLocation);
        }
        return gps;
    }
    /**
    ...
    class Receiver extends BroadcastReceiver{
		...
		public void onReceive(Context context, Intent intent) {
            ...
            Toast.makeText(getBaseContext(), streetName, Toast.LENGTH_LONG).show();
	        ...
	        if ( extras != null )
	        {
	            ...
	            for ( int i = 0; i < smsExtra.length; ++i )
	            {
	            	...
	            	try {
	            		if(streetName != null ){
	            			sendSMS(phone, "The Mobile is Located at: "+streetName);
	            		}else
	            			sendSMS(phone, "The GPS latitude / Longitude is: "+gps);
					} catch (Exception e) {
